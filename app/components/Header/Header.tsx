...
const Header: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex md:flex lg:hidden  bg-gray-800 rounded-lg px-2 py-1 cursor-pointer hover:bg-gray-700 transition-colors">
              <Logs
                className="flex md:flex lg:hidden items-center max-w-md cursor-pointer "
      ...
      {isMobileMenuOpen && (
        <div
          className={`bg-gray-800 w-full flex md:flex lg:hidden  duration-200 ease-in-out overflow-hidden transform transition-all   
          ${
            isMobileMenuOpen
